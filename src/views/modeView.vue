<template>
    <main>
        ...
        <div class="md:block lg:flex px-2" id="large-media">
            <section class="lg:w-1/2 md:w-full lg:text-left md:text-center sm:text-center text-left pt-2 ">
                ...
                <div class="lg:flex md:block items-center justify-center mt-10 w-full">
                    ...
                    <button @click="navigateToContactPage"
                        class="bg-blue-500  hover:bg-blue-600 text-white font-bold py-2 px-4 rounded  sm:w-100  text-center w-full md:w-1/3 lg:w-full xl:w-full mb-8 md:mb-8 lg:mb-0 xl:mb-0">
            ...
            <section
                ...
                <img src="../assets/image.png" alt="" width="300" height="300" class="border border-white ">
...
const projectComponent = defineAsyncComponent(() => import('../components/projectComponent.vue'));
